    ...
    case "payment":
      message = (
        <div className={"app-flex app-flex-col app-gap-3"}>
          <p>
            Awesome! You just bought the <b>{product}</b>{" "}
            lifetime license.
          </p>
          <p>
          ...
          <a
            href="/"
            className="hover:app-cursor-pointer app-px-4 app-py-2 app-bg-purple-900 app-text-white app-rounded hover:app-bg-purple-800 app-transition app-duration-150 app-ease-in-out"
          >
            Compress PDFs
          </a>
          <a
            href="https://billing.stripe.com/p/login/test_3cs7tB4AS5VV86c4gg"
            target="_blank"
...
const PleaseAuth = ({user:firebaseUser}) => {
  const handleLoginWithGoogle = () => {
    ...
    linkWithPopup(firebaseUser, provider).then((result) => {
  ...
  return (
    <div
      className="app-bg-white app-rounded-lg app-p-6 app-shadow-md app-m-2 app-max-w-screen-md app-flex-col app-flex app-gap-3 justify-center">
      <p className="app-text-lg">Your subscription details have been stored locally on your computer. However, to ensure
        your subscription
        information remains accessible across different computers or browsers, please consider registering your Google
        account.</p>
      <div className={"app-flex app-justify-center"}>
        <button
          ...
          <svg className="app-h-6 app-w-6 app-mr-2" xmlns="http://www.w3.org/2000/svg"
      ...
      <p className="app-text-lg">If you have any problem, please contact  <a className={"app-underline"} href={"mailto:contact@saferpdf.com"}>
        contact@saferpdf.com
      </a></p>
    </div>)
}
...
const Success = () => {
  ...
  const unlinkDebug = () => {
    unlink(user.firebaseUser, new GoogleAuthProvider().providerId).then(console.log)
  }
  ...
  return (
    <div className="app-flex app-flex-col app-items-center app-justify-center app-gap-4">
      ...
      {!user.firebaseUser.providerData.length && <PleaseAuth user={user.firebaseUser}/>}
